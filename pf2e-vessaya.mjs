...
import { Enrichers } from "./scripts/journal/enrichers.mjs"
...
Hooks.on("renderJournalSheet", (app, html) => {
	...
	// }
	//
	// $('.sheet.journal-sheet.vessaya .document-title-edit').on("click", () => {
...
Hooks.once("init", async () => {
	Enrichers.initViewScene()
	$(document).on("click", ".viewscene", Enrichers.viewScene)
})
